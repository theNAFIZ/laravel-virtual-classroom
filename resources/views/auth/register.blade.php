                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="batch_id" type="text"
                                           class="form-control @error('batch_id') is-invalid @enderror" name="batch_id"
                                           value="{{ old('batch_id') }}" autocomplete="batch_id" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="id_card"
                                       class="col-md-4 col-form-label text-md-right">{{ __('University ID Card Number') }}</label>
